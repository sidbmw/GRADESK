...
class Ball:
    ...
    def updatep(self, val):
        ...
        self.drawP = self.canvas.create_text(170, 50, font=('freesansbold.ttf', 50), text=str(val), fill='white') #score thing on top

    def updatep1(self, val):
        self.canvas.delete(self.drawP1)
        self.drawP1 = self.canvas.create_text(550, 50, font=('freesansbold.ttf', 40), text=str(val), fill='white') #score thing on top
