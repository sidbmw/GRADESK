...
while event != 'close_window':
    ...
    layout = [
        ...
        [sg.Button('Previous Student', key='_prev_student_'), sg.Button('Next Student', key='_next_student_'), sg.Button("Print Report", key='_print_'),
    ...
    while True:  # Event Loop
        ...
        if event == "_print_":
            ...
            os.system("C:/oraclexe/app/oracle/product/11.2.0/server/bin/sqlplus.exe EOM/EOM @C:/Users/siddh/Documents/ICS4U/SQL/html.sql")
