...
def do_it(course):
    ...
    while event != 'close_window':
        ...
        scrollable_column = [
            [sg.Graph((1200, 300), (0, 450), (450, -60), key='_GRAPH_', change_submits=True, drag_submits=False)]]

        layout = [
            [sg.Text(student_full_name, font='Helvetica', size=(40, 1)),
             sg.Text(class_code, font='Helvetica', size=(40, 1))],
            [sg.Column(scrollable_column, scrollable=True, size=(1200, 300), vertical_scroll_only=True)],
