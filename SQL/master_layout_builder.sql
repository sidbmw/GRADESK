...
begin
delete eom_main_screen_layout where student_id = 1;
...
-------------------------------------------------------------------------------------------------
  ...
  FOR r_x_3PS4M in (select rownum, x_3PS4M, rowid from EOM_MAIN_SCREEN_LAYOUT where expectation = r_exp.expectation AND x_3PS4M is not null AND STUDENT_ID = 1)
  LOOP
